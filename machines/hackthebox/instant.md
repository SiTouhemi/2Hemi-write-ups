...
# Define the hash
stored_hash = 'pbkdf2:sha256:600000$YnRgjnim$c9541a8c6ad40bc064979bc446025041ffac9af2f762726971d8a28272c550ed'

# Function to check the password against the hash
...
alert : remeber to check /tmp/ for suspecious data

Extract encrypted ==.dat== data using a password
